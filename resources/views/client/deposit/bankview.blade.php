    ...
    <h4 class="text-center p-2 bg-dark" style=" color: white !important">Deposit</h4>
        <div class="row mt-3">
            <div class="col-md-4 p-3">
               ...
               <a href="{{route('client.depsoist_bank_view')}}" class="btn btn-dark mt-5 active">
                       BANK TRANSFER
                    ...
                    <a href="{{route('client.depsoist_phonepe_view')}}" class="btn btn-dark mt-2">
                        PHONEPE
                        ...
                        <div class="row">
                            ...
                            <div class="card">
                                <div class="card-header bg-dark">
                                    <h4 class="text-white">Transfer Detail</h4>
                                </div>
                                <div class="card-header">
    <div class="d-flex align-items-center">
        <h4 class="mb-0 text-bold">Bank: <span style="font-weight: bold;">{{$account->b_name}}</span></h4>
        <a class="btn btn-warning ms-3" onclick="copyText('{{$account->b_name}}')">Copy</a>
    </div> 
    <div class="d-flex align-items-center">
        <h4 class="mb-0 text-bold">Account Title: <span style="font-weight: bold;">{{$account->title}}</span></h4>
        <a class="btn btn-warning ms-3" onclick="copyText('{{$account->title}}')">Copy</a>
    </div>     
    <div class="d-flex align-items-center">
        <h4 class="mb-0 text-bold">Account: <span style="font-weight: bold;">{{$account->number}}</span></h4>
        <a class="btn btn-warning ms-3" onclick="copyText('{{$account->number}}')">Copy</a>
    </div>  
    <div class="d-flex align-items-center">
        <h4 class="mb-0 text-bold">Account Type: <span style="font-weight: bold;">{{$account->Account_type}}</span></h4>
        <a class="btn btn-warning ms-3" onclick="copyText('{{$account->Account_type}}')">Copy</a>
    </div>  
    <div class="d-flex align-items-center">
        <h4 class="mb-0 text-bold">IFSC Number: <span style="font-weight: bold;">{{$account->ifsc}}</span></h4>
        <a class="btn btn-warning ms-3" onclick="copyText('{{$account->ifsc}}')">Copy</a>
    </div> 
    <div class="d-flex align-items-center">
        <h4 class="mb-0 text-bold">Branch: <span style="font-weight: bold;">{{$account->branch}}</span></h4>
        <a class="btn btn-warning ms-3" onclick="copyText('{{$account->branch}}')">Copy</a>
    </div> 
</div>

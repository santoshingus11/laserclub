      ...
      <div class="row">
        ...
        <div class="col-lg-10 col-md-12 col-sm-12">
          <div class="Home_pages_main_section mybets">
            <h1 class="event_Cricket">20-20 Dragon Tiger 2 Results</h1>
            <div class="row mb-4">
              ...
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="Race20ResultLabel">20-20 Dragon Tiger 2 Results</h5>
                  ...
                  <div class="modal-body race-modal">
                    <div class="container-fluid race-modal">
                      <div class="row player-container m-t-10">
                        ...
                        <div class="col-md-12">
                          <h6 class="text-right"><b>Round Id :</b> 231412111442</h6>
                          <div class="race-result-box">
                            <div class="pr mb-1"><span class="result-image"><img src="{{asset('frontend/assets/cards/spade.png')}}"></span> <span class="result-image k-image"><img src="{{asset('frontend/assets/cards/KHH.png')}}"></span></div>
                            <div class="pr mb-1"><span class="result-image"><img src="{{asset('frontend/assets/cards/heart.png')}}"></span> <span class="result-image k-image"><img src="{{asset('frontend/assets/cards/KDD.png')}}"></span>
                        ...
                        <div class="col-md-12">
                          <p class="text-center mt-3"><b class="text-success">Result: </b> Tiger|No Pair*Black|Odd|Card7*Black|Odd|Card9</p>
                        </div>
                      </div>
                    </div>

                    <div>
                      <h6 class="text-right round-id"><b>Round Id:</b> 231412111442
                      </h6>
                      <div class="text-center luckyseven-img"><img src="{{asset('frontend/assets/cards/7HH.png')}}"> <img src="{{asset('frontend/assets/cards/9CC.png')}}"></div>

...
@if(Auth::guard('client')->user())
 <div class="d-sm-none"> <!-- Hide on screens larger than small (sm) -->
    <div class="Welcometo-section">
        @include('layouts.client-balance-section')
    </div>
</div>
 @endif
  @include('layouts.client-buttons',['page' => 'sports'])
        ...
        <div class="col-lg-3 col-md-12 col-sm-12">
          <div class="homepages-right-section">
            <div class="account-overview">
              <div data-bs-toggle="collapse" class="Credit_home_button" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample"><span><strong>Available Credit: </strong> <span class="value">{{$available_credit}}</span></span>

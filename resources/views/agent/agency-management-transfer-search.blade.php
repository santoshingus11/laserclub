...
<tr>
  ...
  <td>{{$sc->balance}}</td>
  <td data-bs-toggle="modal" data-bs-target="#Transferforsmdemo1" onclick="sendids('{{$sc->id}}','{{$sc->username}}')" class="pointer eye-view">Transfer @if(Auth::guard('agent')->user()->role_id == 4) /Withdraw @endif</td>
</tr>
@endforeach
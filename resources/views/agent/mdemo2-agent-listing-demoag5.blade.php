            ...
            <div class="card overflow-hidden">
              <div class="card-body">
                <div class="d-flex justify-content-between align-items-baseline mb-2">
                  <h4 class="mb-0 font-14"><em><span class="text-info">Downline Listing ></span> mdemo2</em></h4>
                    ...
                    <div class="activity-report">
                      <div class="main-panel d-flex justify-content-start align-items-baseline">
                        ...
                        <div class="mid-panel w-100">
                          <table class="table table-striped mobile-table-striped">
                            <thead>
                              <tr>
                      ...
                      <div class="Pand-l-Statement">
                        <div class="Agent_-Listing height30vh">
                          <div class="table-responsive">
                            ...
                            <table class="table table-striped displayunblock w-100">
                              <thead>
                                <tr>
                                  <th class="">Date</th>
                                  <th class="">Description</th>

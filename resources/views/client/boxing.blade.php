                ...
                <nav class="tree-menu">
                  <div class="left-menu-inner">
                    <ul class="menu-column menu-prev">
                      ...
                      <li><a href="" class="link-lvl-sport router-link-exact-active router-link-active"><img src="{{asset('frontend/assets/icons/6.png')}}" class="game-icon"> <span class="link-name">Boxing</span></a></li>

                ...
                <nav class="tree-menu">
                  <div class="left-menu-inner">
                    <ul class="menu-column menu-prev">
                      ...
                      <li><a href="" class="link-lvl-sport router-link-exact-active router-link-active"><img src="{{asset('frontend/assets/icons/71.png')}}" class="game-icon"> <span class="link-name">Badminton</span></a></li>
        ...
        <div class="col-lg-7 col-md-12 col-sm-12">
          <div class="Home_pages_main_section">
            <div class="sports-wrapper block">
              <div class="events">
                <h1 class="event_Cricket">Badminton

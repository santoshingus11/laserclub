                  ...
                  <div class="dScreen book_makers">
                    <div class="row mx-0 head_bg">
                      <div class="col-md-12 col-8 px-0">
                        <p class="match-odds">ATP ROME WINNER 2024 <a href="javascript:void(0)"><i class="mdi mdi-information-outline"></i></a></p>
                      </div>
                    ...
                    <div class="row mx-0 odds_body">
                      <div class="col-md-5 col-7 px-0">
                        <p class="team-name"> Stefanos Tsitsipas <!----><!----></p>
                      </div>
                      <div class="col-md-7 col-5 px-0">
                    ...
                    <div class="row mx-0 odds_body">
                      <div class="col-md-5 col-7 px-0">
                        <p class="team-name"> Alexander Zverev <!----><!----></p>
                      </div>
                      <div class="col-md-7 col-5 px-0">

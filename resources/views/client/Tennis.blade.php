                          ...
                          <div><app-guest-sport-list-element>
                              <div class="row align-items-center row-my">
                                <div class="col-md-6 col-10 px-1">
                                  @if($r['status']==1)  
                                  <p class="matchname"><a href="{{ route('tenis-details',$r['id']) }}" class="item-inplay"><img src="{{asset('/')}}assets/icon-in_play.png" class="img-fluid">  {{$r['game_title']}}
                                    </a><b><span class="in_play img-fluid">In-Play</span><span class="in_play img-fluid"><img src="{{asset('/')}}assets/tv.svg"></span><span class="game-fancy"><img src="{{asset('/')}}assets/icon-fancy.svg" class="img-fluid"></span><span class="game-bm"><img src="{{asset('/')}}assets/icon-bookmaker.svg" class="img-fluid"></span><span class="game-custom">T </span><span class="timer-on">{{date('d/m/Y H:i', strtotime($r['created_at']))}}</span></b>
                                  </p>
                                  @else
                                  <p class="matchname"><a><img src="{{asset('/')}}assets/icon-no_play.png" class="img-fluid">  {{$r['game_title']}} </a><b><span class="in_play img-fluid"><img src="{{asset('/')}}assets/tv.svg"></span><span class="game-bm"><img src="{{asset('/')}}assets/icon-bookmaker.svg" class="img-fluid"></span><span class="game-custom">T </span><span class="timer-on">{{date('d/m/Y H:i', strtotime($r['created_at']))}}</span></b>
                                  </p>
                                  @endif
                                </div>
                                ...
                                <div class="col-md-4 col px-0">
                                   @if($r['status']==1)  
                                  <a href="{{ route('tenis-details',$r['id']) }}"><div class="oddsEventlist">

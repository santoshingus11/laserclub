...
@include('layouts.client-header')
  ...
  @include('layouts.client-buttons',['page' => 'sport_betting'])
        ...
        <div class="col-lg-7 col-md-12 col-sm-12">
          <div class="Home_pages_main_section">
            <div class="sports-wrapper block">
              <div class="events">
                   <h1 class="event_Cricket">Sports Betting
             ...
             <!--</div>-->
                <div class="events-row mt-5">
                  <div class="row">
                       <div class="col-md-6 col-lg-3 col-sm-6 col-xs-6">
                            <div class="Lottery">
                                <div class="d-inline-block casino-image">
                                    <a href="{{ url('/slot/game/lounch') }}/{{ $data['games'][0]->id }}">
                                        <img src="{{asset('frontend/assets/images/ipl.jpg')}}" class="img-fluid">
                                    </a>
                                </div>
                            </div>
                        </div>
                  @foreach($data['games'] as $game)
                        @if($game->id != 3001 && $game->id != 3002)
                        <div class="col-md-6 col-lg-3 col-sm-6 col-xs-6">
                            <div class="Lottery">
                                <div class="d-inline-block casino-image">

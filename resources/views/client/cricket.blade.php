                ...
                <div class="row">
                  <div class="col-12">
                    <div class="eventlistdesign">
                      <h2 class="high-desktop"> &nbsp;&nbsp; Cricket <div class="dropdown viewby-filter"><button type="button" id="ViewBy" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle"><i class="mdi mdi-filter"></i> View by </button>
                      ...
                      <h2 class="high-mobile"> &nbsp;&nbsp; Cricket <div class="dropdown viewby-filter"><button type="button" id="ViewBy" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle"><i class="mdi mdi-filter"></i> View by </button>
                          <div aria-bs-labelledby="ViewBy" class="dropdown-menu"><a href="javascript:void(0)">Competition</a><a href="javascript:void(0)" class="active">Time</a></div>
                        </div>
                      </h2>
                      <div>
                          ...
                          <div><app-guest-sport-list-element>
                              <div class="row align-items-center row-my">
                                <div class="col-md-6 col-10 px-1">
                                  @if($r['status']==1)
                                  <p class="matchname"><a href="{{ route('Cricket-details',$r['id']) }}" class="item-inplay"><img src="{{asset('/')}}assets/icon-in_play.png" class="img-fluid"> {{$r['game_title']}}
                                    </a><b><span class="in_play img-fluid">In-Play</span><span class="in_play img-fluid"><img src="{{asset('/')}}assets/tv.svg"></span><span class="game-fancy"><img src="{{asset('/')}}assets/icon-fancy.svg" class="img-fluid"></span><span class="game-bm"><img src="{{asset('/')}}assets/icon-bookmaker.svg" class="img-fluid"></span><span class="game-custom">T </span><span class="timer-on">{{$istTime}} (IST)</span></b>
                                  </p>
                                  @else
                                  
                                  <p class="matchname"><a href="{{ route('Cricket-details',$r['id']) }}"><img src="{{asset('/')}}assets/icon-no_play.png" class="img-fluid"> {{$r['game_title']}} </a><b><span class="in_play img-fluid"><img src="{{asset('/')}}assets/tv.svg"></span><span class="game-bm"><img src="{{asset('/')}}assets/icon-bookmaker.svg" class="img-fluid"></span><span class="game-custom">T </span><span class="timer-on">{{$istTime}} (IST)</span></b>
                                  </p>
                                  @endif
                                </div>

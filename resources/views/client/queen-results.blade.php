      ...
      <div class="row">
        ...
        <div class="col-lg-10 col-md-12 col-sm-12">
          <div class="Home_pages_main_section mybets">
            <h1 class="event_Cricket">Queen Results</h1>
            <div class="row mb-4">
                  ...
                  <div class="modal-body race-modal">
                    <div class="container-fluid">
                      <div class="row player-container m-t-10">
                        ...
                        <div class="col-md-12">
                          <h6 class="text-right"><b>Round Id :</b> 231312160509</h6>
                          <div class="row text-center m-t-10">
                            <div class="col-md-12 text-center player-number">
                              <div class="player-image-container">
                                <h2>Player 8</h2> <img src="assets/cards/5DD.png"><img src="assets/cards/4HH.png"><img src="assets/cards/6HH.png">
                                <div class="col-md-12 text-center"><label class="winner-label m-t-20"><i class="fas fa-trophy m-r-5"></i>
                                    Winner</label></div>
                              </div>
                            </div>
                          </div>
                          <div class="row text-center m-t-10">
                            <div class="col-md-12 text-center player-number">
                              <div class="player-image-container">
                                <h2>Player 9</h2> <img src="assets/cards/6SS.png"><img src="assets/cards/2CC.png">
                              </div>
                            </div>
                          </div>
                          <div class="row text-center m-t-10">
                            <div class="col-md-12 text-center player-number">
                              <div class="player-image-container">
                                <h2>Player 10</h2> <img src="assets/cards/2DD.png"><img src="assets/cards/4SS.png">
                              </div>
                            </div>
                          </div>
                          <div class="row text-center m-t-10">
                            <div class="col-md-12 text-center player-number">
                              <div class="player-image-container">
                                <h2>Player 11</h2> <img src="assets/cards/4CC.png"><img src="assets/cards/2HH.png">
                              </div>
                            </div>
                          </div>
                        </div>

                ...
                <nav class="tree-menu">
                  <div class="left-menu-inner">
                    ...
                    <ul class="menu-column menu-prev sport-type-Cricket">
                      <li><a href="home.php" class="home-link"><i class="fas fa-home"></i> <span class="link-name">Sports</span></a></li>
                      ...
                      <li><a href="Cricket.php" class="link-lvl-prev"><i class="fas fa-chevron-circle-left"></i> <span class="link-name">Previous</span></a></li>
                      <span>
        ...
        <div class="col-lg-7 col-md-12 col-sm-12">
          <div class="Home_pages_main_section">
            <div class="sports-wrapper block">
              <div class="events">
                <h1 class="event_Cricket">Australia T10 v West Indies T10
                  <span class="starts-in-label">17/11/2023 14:10:00</span>
                </h1>
                <div class="all-details-pages-live-data">
                  <img src="assets/images/cricketv.png" alt="" class="img-fluid w-100">
                </div>
                  ...
                  <div class="row bookmaker-market">
                    <div class="bm1 col-xl-12">
                      <div>
                        ...
                        <table class="market-listing-table table m-b-0 m-t-5">
                          ...
                          <tbody>
                            <tr data-title="SUSPENDED" class="suspended">
                              <td>
                                <div class="event-name" style="color: rgb(15, 35, 39);">CHE XI</div>
                            ...
                            <tr data-title="ACTIVE" class="">
                              <td>
                                <div class="event-name" style="color: rgb(15, 35, 39);">PUN XI</div>
                                <p class="m-b-0"><span style="color: black;">0</span> <span style="display: none; color: black;"> &gt;&gt; 0</span></p>
                              </td>
                              <td class="back unhighlighted betting-disabled"><strong class="odds">0</strong>
                                <div class="size"><span>0.0</span></div>
                              ...
                              <td class="back"><strong class="odds">10</strong>
                                <div class="size"><span>100K</span></div>
                              </td>
                              <td class="lay"><strong class="odds">15</strong>
                                <div class="size"><span>100K</span></div>
                              </td>
                              <td class="lay unhighlighted betting-disabled"><strong class="odds">0</strong>
                                <div class="size"><span>0.0</span></div>
                        ...
                        <div class="min-max text-right mt-1" style="border-bottom: 0px;"><span>Min: <span>50</span></span> <span>Max: <span>50K</span></span></div>
                        <div class="marquee">
                          <p>Play Worlds`s Fastest Cricket Game Ball By Ball Started In Our Exchange!!!</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="fancy-market-container">
                    <div class="fancy-market">
                      <div class="row m-b-20">
                        <div class="col-md-12">
                          <div class="game-title m-t-5">
                            <h5 class=" d-inline-block m-b-0">Fancy Market</h5>
                          </div>
                          ...
                          <div class="table-body">
                            <div class="fancy-tripple">
                              <div data-title="SUSPENDED" class="table-row">
                                ...
                                <div class="box-w1 lay float-left text-center"><span class="odd d-block">29</span> <span>100</span></div>
                                <div class="box-w1 back float-left text-center"><span class="odd d-block">30</span> <span>100</span></div>
                            ...
                            <div class="fancy-tripple">
                              <div data-title="SUSPENDED" class="table-row">
                                ...
                                <div class="box-w1 lay float-left text-center"><span class="odd d-block">39</span> <span>100</span></div>
                                <div class="box-w1 back float-left text-center"><span class="odd d-block">40</span> <span>100</span></div>
                                <div class="box-w2 float-left text-right min-max" style="border-bottom: 0px;"><span class="d-block">Min: <span>50</span></span> <span class="d-block">Max: <span>50K</span></span></div>
                              </div>
                            </div>
                            <div class="fancy-tripple">
                              <div data-title="SUSPENDED" class="table-row">
                                <div class="float-left country-name" style="border-bottom: 0px;">
                                  <p class="m-b-0"><span>
                                      Fall of 3rd wkt PUN XI
                                    </span> <img src="assets/icons/ladder.png" class="float-right ladder-icon m-t-5"></p>
                                  <p class="m-b-0"><span style="color: black;">0</span></p>
                                </div>
                                <div class="box-w1 lay float-left text-center"><span class="odd d-block">41</span> <span>110</span></div>
                                <div class="box-w1 back float-left text-center"><span class="odd d-block">41</span> <span>90</span></div>
                                <div class="box-w2 float-left text-right min-max" style="border-bottom: 0px;"><span class="d-block">Min: <span>50</span></span> <span class="d-block">Max: <span>50K</span></span></div>
                              </div>
                            </div>
                            <div class="table-remark text-right">
                              <p class="m-b-0">***Formula 1 Las Vegas Grand Prix Bet Started In Our Exchange***</p>
                            </div>
                          </div>
                        </div>
                      </div>

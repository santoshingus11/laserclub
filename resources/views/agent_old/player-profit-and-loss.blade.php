              ...
              <div class="card-body">
                <div class="d-flex justify-content-between align-items-baseline mb-4 mb-md-3 pb-2 border-bottom">
                  <div class="d-inline-flex align-items-center">
                    <h4 class=" mb-0">Player Profit and Loss</h4>
                  </div>
                      ...
                      <div class="_Account-Statement user_profile_-">
                        <nav>
                          <div class="nav nav-tabs current-bets-nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <button class="nav-link current-bets-nav-link font-15" id="nav-BPoker-tab-profitLoss" data-bs-toggle="tab" data-bs-target="#nav-BPoker" type="button" role="tab" aria-controls="nav-BPoker-profitLoss" aria-selected="false" tabindex="-1">BPoker</button>
                            <button class="nav-link current-bets-nav-link font-15" id="nav-Casino-tab-profitLoss" data-bs-toggle="tab" data-bs-target="#nav-Casino" type="button" role="tab" aria-controls="nav-Casino" aria-selected="false" tabindex="-1">Casino</button>
                            <button class="nav-link current-bets-nav-link font-15" id="nav-SABA-tab-profitLoss" data-bs-toggle="tab" data-bs-target="#nav-SABA" type="button" role="tab" aria-controls="nav-SABA" aria-selected="false" tabindex="-1">SABA</button>
                            <button class="nav-link current-bets-nav-link font-15" id="nav-SkyTrader-tab-profitLoss" data-bs-toggle="tab" data-bs-target="#nav-SkyTrader" type="button" role="tab" aria-controls="nav-SkyTraders" aria-selected="false" tabindex="-1">SkyTrader</button>
                            <button class="nav-link current-bets-nav-link font-15" id="nav-MiniGame-tab-profitLoss" data-bs-toggle="tab" data-bs-target="#nav-MiniGame" type="button" role="tab" aria-controls="nav-MiniGame" aria-selected="false" tabindex="-1">MiniGame</button>
                            <button class="nav-link current-bets-nav-link font-15" id="nav-Royal-tab-profitLoss" data-bs-toggle="tab" data-bs-target="#nav-Royal" type="button" role="tab" aria-controls="nav-Royal" aria-selected="false" tabindex="-1">Royal</button>
                          </div>
                        </nav>

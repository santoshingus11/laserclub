<ul class="nav">
    <li class="nav-item">
    <a class="nav-link" data-bs-toggle="collapse" href="#deposit_withdraw" role="button" aria-expanded="false" aria-controls="deposit_withdraw">
      <span class="link-title">Deposit & Withdraw</span>
      <i class="link-arrow" data-feather="chevron-down"></i>
    </a>
    <div class="collapse" id="deposit_withdraw">
      <ul class="nav sub-menu">
     
      <a href="{{route('agent.paytmAccountView')}}" class="nav-link"> Set Account</a> 
      <a href="{{route('agent.deposit_request')}}" class="nav-link">Deposit Requests</a>
      <a href="{{route('agent.withdraw_request')}}" class="nav-link">Withdraw Requests</a>
  ...
  <li class="nav-item">
      <a href="{{url('admin/chat/Users')}}" class="nav-link">
          Chat
      </a>
  </li>

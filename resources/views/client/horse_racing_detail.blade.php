                ...
                <div class="dScreen">
                  <div class="row mx-0">
                    <div class="col-md-12 col-12 px-0">
                      <p class="match-odds"><!----><a href="javascript:void(0);" class="add-pins"><img src="assets/img/pin-white.svg" class="img-fluid"></a><!----> {{isset($game_single) ? $game_single['game_title'] : ''}} <a href="javascript:void(0)"><i class="mdi mdi-information"></i></a><!----><span><!----><button class="btn-cashout">Betting Open</button><!----><!----></span><!----></p>
                    </div>
                  </div>

        ...
        <div class="col-lg-7 col-md-12 col-sm-12">
          <div class="Home_pages_main_section">
            <div class="sports-wrapper block">
              <div class="events">
                <h1 class="event_Cricket">Kabaddi
                ...
                <div class="events-row extra-data-height-scroll">
                  <div class="events-row">
                    <table class="market-listing-table">
                      ...
                      <tbody>
                        <tr>
                          <td><a href="{{route('Kabaddi-details')}}" class="event-name">Delhi Demo v Jaipur Demo</a> <small><span>27/10/2023 00:00:00</span></small></td>
                          <td class="back"><strong class="odds">0</strong></td>
                          <td class="lay"><strong class="odds">0</strong></td>
                          <td class="empty"><span>
                              0
                            </span></td>
                          <td class="empty"><span>0</span></td>
                          <td class="back"><strong class="odds">0</strong></td>
                          <td class="lay"><strong class="odds">0</strong></td>
                        </tr>
                      </tbody>

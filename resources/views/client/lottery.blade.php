              ...
              <div class="events">
                 ...
                 <div class="row mb-5">
                     <div class="btn-group-container" style="overflow-x: auto; white-space: nowrap; width: 100%;">
                        <div class="btn-group align-item-center" style="display: flex; justify-content: space-between;">
                            ...
                            <button class="btn btn-dark btnclass" onclick="filterGames('{{$label->id}}')">{{strtoupper($label->name)}}</button>
                            @endforeach
                        </div>
                     </div>
                </div>
                <div class="events-row">
                  ...
                  <div class="row" id="gameContainer">
                       ...
                       <div class="col-md-6 col-lg-3 col-sm-12 game_item" data-catid="{{$game->cat_id}}">
                      <div class="Lottery">
                        <div class="d-inline-block casino-image"><a href="{{ url('/slot/game/lounch') }}/{{ $game->game_id }}"><img
                              src="{{$game->img}}" class="img-fluid"></a></div>
                      </div>
                    </div>

                  ...
                  <div class="dScreen book_makers">
                    <div class="row mx-0 head_bg">
                      <div class="col-md-12 col-8 px-0">
                        <p class="match-odds">BOOKMAKER (IPL CUP WINNER) <a href="javascript:void(0)"><i class="mdi mdi-information-outline"></i></a></p>
                      </div>
                    ...
                    <div class="row mx-0 odds_body">
                      <div class="col-md-5 col-7 px-0">
                        <p class="team-name"> Royal Challengers Bangalore <!----><!----></p>
                      </div>
                      <div class="col-md-7 col-5 px-0">
                        <div class="btn-group dOddsBox"><button class="back back2">- <span>-</span></button><button class="back back1">- <span>-</span></button><button class="back bet_text">1400</button><button class="lay bet_text">1700</button><button class="lay lay1">- <span>-</span></button><button class="lay lay2">- <span>-</span></button><!----></div>
                      </div>
                    ...
                    <div class="row mx-0 odds_body">
                      <div class="col-md-5 col-7 px-0">
                        <p class="team-name"> Kolkata Knight Riders <!----><!----></p>
                      </div>
                      <div class="col-md-7 col-5 px-0">
                        <div class="btn-group dOddsBox"><button class="back back2">- <span>-</span></button><button class="back back1">- <span>-</span></button><button class="back bet_text">170 <span>0</span></button><button class="lay bet_text">190 <span>0</span></button><button class="lay lay1">- <span>-</span></button><button class="lay lay2">- <span>-</span></button><!----></div>
                      </div><!---->
                    </div><!----><!---->
                  </div>
                </div><!----><!---->

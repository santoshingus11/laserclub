            ...
            <div class="sports-wrapper block">
              <div class="events">
                <div class="all-details-pages-live-data">
                  <img src="assets/images/virtualgame.png" alt="" class="img-fluid w-100">
                </div>
                        ...
                        <div class="col-md-12">
                          ...
                          <div class="table-body">
                            <div class="fancy-tripple">
                              <div data-title="Starting soon." class="table-row suspended-fancy">
                                <div class="float-left country-name" style="border-bottom: 0px;">
                                  <p class="m-b-0"><span>
                                      Match 1st over run(BANV vs SAV)adv
                                ...
                                <div class="box-w1 back float-left text-center betting-disabled"><!----></div>

...
<body>
  ...
  <div class="main-wrapper">
    <div class="responsiblegambling">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12 mt-3">
            <div class="logo-responsiblegambling">
              <a href="index.php" class="logo router-link-active"><img src="{{asset('admin/Super-Admin/assets/img/logo.png')}}" class="m-t-15" style="height: 80px;"></a>
            </div>
          </div>
          <div class="col-md-12 mt-3">
            <div class="responsiblegambling-content">
              <h3>Responsible Gambling</h3>
              <h4 class="mt-3">Understanding difficulties with gambling</h4>
              <p>On this site you will find practical points about maintaining control of your
                gambling. There is also
                a self-assessment questionnaire which can be used to help identify possible difficulties with
                gambling if you are concerned about your own or somebody else's gambling.</p>
              <h4 class="mt-3">Symptom Assessment:</h4>
              <ul>
                ...
                <li>After losing, did you feel the urge to return as soon as possible to win back
                  your losses?</li>
              ...
              <h4 class="mt-4">Tools that you can use</h4>
              <p>We offer a range of different options that can be used to manage gambling activity
                as and when you
                wish. This includes tools which allow you to limit the amount you can deposit or lose, or the option
                to exclude yourself from gambling for a fixed period of time.</p>
              <h4 class="mt-4">Support and help information</h4>
              <p>If you feel you need further guidance and support about money worries, personal or
                emotional
                ...
                and global organizations and the contact information for them.</p>
              <ul class="mt-4">
                <li><a href="#">Gamblers
                    Anonymous</a></li>
                <li><a href="#">GamCare</a></li>
                <li><a href="#">The Canadian
                    Foundation on Compulsive Gambling</a></li>
              </ul>
            </div>
          </div>
        </div>

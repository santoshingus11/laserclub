              ...
              <div class="card-body pt-2">
                <div class="d-flex justify-content-between align-items-center pb-2 border-bottom global-settings_m">
                  <div class="d-inline-flex align-items-center">
                    <h4 class=" mb-0"> Market Rollback</h4>
                  </div>
                        ...
                        <table class="table table-striped table-bordered">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td class="text-center">Casino</td>
                              <td class="text-center">Race 20-20</td>
                              <td class="text-center">Race 20-20</td>
                              <td class="text-center">Total Card</td>
                              <td class="text-center">46.2310101057142222</td>
                              <td class="text-center">K of Diamond</td>
                              <td class="text-center">2023-07-01 11:17:01</td>
                              <td class="align-C border-l d-flex align-items-center justify-content-center">
                                <button type="submit" class="btn_replay normal_with w1-100 font-13  mx-2">Rollback</button>
                              </td>
                            </tr>
                            <tr>
